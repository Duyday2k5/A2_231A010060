...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "A2_231A010060";
    ...
    private CheckBox cbPauseBackground;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbPauseBackground = findViewById(R.id.cbPauseBackground);
        ...
        if (savedInstanceState != null) {
            ...
            cbPauseBackground.setChecked(savedInstanceState.getBoolean(KEY_PAUSE_BG));
    ...
    private void recordLap() {
        ...
        lapList.add(0, "Vòng " + (lapList.size() + 1) + " - " + timeStr); // thêm vào đầu danh sách

        updateUi();

        Log.i(TAG, "Ghi vòng: " + timeStr);
    ...
    protected void onStop() {
        ...
        if (cbPauseBackground.isChecked() && running) {

            pauseStopwatch();

            Log.i(TAG, "onStop: Tự động dừng vì tuỳ chọn Dừng khi ra nền được bật");
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(KEY_PAUSE_BG, cbPauseBackground.isChecked());
